...
const About = () => {
    return (
        <div>
            ...
            <div className="z-0 mx-auto flex max-w-7xl px-8 lg:px-0 flex-col-reverse items-center justify-center gap-y-12 lg:flex-row lg:gap-y-0 lg:space-x-10">
                <article className="space-y-6 sm:text-lg lg:w-1/2">
                    <p>
                        I am a results-driven Software Engineer with a focus on Full Stack Web Development. Currently
                        working as a Full Stack Engineer at a leading cloud service provider in Türkiye, I am committed
                        to continuous learning and staying at the forefront of web and design technologies.
                    </p>
